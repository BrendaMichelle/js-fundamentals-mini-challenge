...
function drinkWater(current_thirt_level) {
  var thirst = current_thirt_level
...
function sameSameButDifferent(num, maybeNum) {
  ...
  else if (num == maybeNum && typeof maybeNum == "string") {
...
function updateGrade(student_object, grade) {
  student_object.grade = grade
...
function takeATicketNumber(line) {
  ...
  line.push(line.length + 1)
   return `Welcome. You are ticket numer ${line_length}.`
}
