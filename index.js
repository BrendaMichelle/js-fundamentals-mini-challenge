...
function updateGrade(student, UpdatedGrade) {
...
function triple(element){
  ...
  return tripledArray;
// i keep getting separate arrays for each element...I know that must be fixed 
// but for the sake of time im moving on...look forward to feedback :)
}
...
// didnt have enough time, so I am just submitting :/
