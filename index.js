...
function sameSameButDifferent(num, maybeNum) { 
  const maybeNumInt = parseInt(maybeNum, 10)
  if (Number.isInteger(num) && num === maybeNum)
    return "same same"
  if (num === maybeNumInt)
...
otherNewLine.push(1)
line.push(otherNewLine.length)
return `Welcome. You are ticket number ${otherNewLine.length}`
newLine += 1
}
...
// Quite confused by this bonus question tbh 
// pls explain a bit thank you!!!!!
