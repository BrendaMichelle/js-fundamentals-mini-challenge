...
// ***** Question 4 *****
// *** Uncomment the lines below to test
//`sameSameButDifferent` that takes in two arguments, `num` and `maybeNum`
...
// define triple and then use it as call back
function triple(n){
  console.log(n * 3)
  return triple
}
...
function takeATicketNumber(line){
  //let ticketNumber = 0  will start 0 every time
   ticketNumber ++
...
console.log(takeATicketNumber(line))
// // => `Welcom e. You are ticket number 3`
