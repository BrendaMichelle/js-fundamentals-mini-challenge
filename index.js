...
function printNameAndPhones(users) {
  users.forEach(function (usersHash) {
    console.log(usersHash.name)
    console.log(`Cell: ${usersHash.phones.cell}`)
    console.log(`Office: ${usersHash.phones.office}`)
  })
}
...
+++ "THE CODE BELOW DIDN'T WORK AND I'M A LITTLE SHAKY ON CLOSURES" +++ 
