...
const printNameAndPhones = (user) => {
  for (i = 0; i < users.length; i++){
    console.log(users[i]["name"])
    console.log(users[i]["phones"]["cell"])
    console.log(users[i]["phones"]["office"])
  }
}
...
// function takeTickerNumber(line) {
//   ticket += 1;
//   line.push(ticket)
//   return `Welcome. You are ticket number ${ticket}`
// }
// console.log(takeTickerNumber(line))
...
"please check question 6 i belive tried writing it multiple ways and keep getting an error"