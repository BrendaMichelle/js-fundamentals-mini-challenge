...
function takeATicketNumber(line) {
  line.push(tickCounter)
  tickCounter ++
  return `Welcome. You are ticket number ${line[line.length-1]}.`
}
...
function ticketNumberGeneratorFunc () {
  let counterNew = 1
  function takeATicketNumberNew() {
    newLine.push(counterNew)
    counterNew ++
    return `Welcome. You are ticket number ${newLine[newLine.length-1]}.`
  }
  return takeATicketNumberNew;
}
