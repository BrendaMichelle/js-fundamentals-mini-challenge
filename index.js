...
function drinkWater(currentThirstLevel) {
  ...
  console.log("Add that hits the spot")
...
function ticketNumberMaker(line) {
  nextNum = 1
  return function ticketMaker(line) {
    line.push(nextNum)
    nextNum++
    return `Welcome. You are ticket number ${nextNum - 1}`
  }
}
const takeATicketNumber = ticketNumberMaker()
...
// oh lol whoops i did that already but i called it "ticketNumberMaker"
const takeATicketNumberFunc = ticketNumberMaker()
