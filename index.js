...
function sameSameButDifferent(arg1, arg2) {
  if (arg1 === arg2) {
    return "same same"
  } else if (arg1 == arg2) {
...
function  printNameAndPhones(arrOfHashes) {
  for (i = 0; i < arrOfHashes.length; i++) {
    console.log(arrOfHashes[i]['name'])
    console.log(arrOfHashes[i]['phones']['cell'])
    console.log(arrOfHashes[i]['phones']['office'])
  }
}
...
function ticketNumberGeneratorFunc(array) {
  ...
  return `Welcome. You are ticket number ${array.length}`
}
