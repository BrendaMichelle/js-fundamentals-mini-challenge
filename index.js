...
function drinkWater(currentThirstLevel) {
  ...
  currentThirstLevel = currentThirstLevel - 1
...
function takeATicketNumber(line) {
   i += 1
   line.push(i)
   return `Welcome. You are ticket nummber ${i}`
}
...
console.log("Going to finish working on the last one tonight")
// const newLine = []
