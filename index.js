...
function sameSameButDifferent(num, maybeNum) {
  if (num === maybeNum & typeof num === 'number' & typeof maybeNum === 'number') {
    return 'same same'
...
function takeATicketNumber(line) {
  ...
  i++
  a++
  return `Welcome. You are ticketNumber${i}`
}
// im probably doing this wrong, only way I came up with
// to pass tests
...
// not sure if this is correct either even though it passed tests
// Did not really understand what higher order function meant
// *** Uncomment the lines below to test
