...
// let currentThirstLevel = 5; 

function drinkWater(currentThirstLevel) {
  if (currentThirstLevel < 15) {
    return "Man I sure an thirsty"}
    else {
    return " Ahh that hits the spot"
  }
}
console.log(drinkWater(15))
...
function takeATicketNumber(line) {
  ...
  ticketNumber += 1
  return `Welcome. You are ticket number ${ticketNumber - 1}.`
}
