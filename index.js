...
function printNameAndPhones(users){
  users.forEach(function callback(element){
...
// *** Uncomment the lines below to test
console.log("%cScope & Closures - Question 1", "color: red") // [DONE]
...
// *** Uncomment the lines below to test
console.log("%cScope & Closures - Question 2", "color: red") // [DONE]

function ticketNumberGeneratorFunc(newLinw){
  let ticketNum = 0
  
  function createTicketNumber(){     
    ticketNum++ 
    newLine.push(ticketNum)
...
//console.log(takeATicketNumberFunc)
