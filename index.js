...
function sameButDifferent(num, maybeNum) {
  if (num === maybeNum) {
    return "same same"
  }
...
function printNameAndPhones(users) {
  users.forEach (function (userObject) {
    ...
    console.log(`${userObject.phones.cell}`)
    console.log(`${userObject.phones.office}` )
  })
}
const users = [ 
  { 
...
// I ran out of time :(  Wanted to make sure I could submit! Also not at all confident on how to approach this yet. 
const newLine = []
